  ...
  return (
    <>
      ...
      <div className="h-screen w-screen bg-[url('/img/login-bg.svg')] bg-no-repeat bg-center bg-cover overflow-x-hidden before:relative">
        <div className="flex flex-col justify-center items-center h-screen translate-x-0 tr">
          <div className="flex space-x-3 items-center justify-center">
            <Image width={50} height={50} src={'/img/logo.svg'} />
            <h1 className="text-primary text-5xl font-serif tracking-widest">VMS</h1>
          </div>
          <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-[0px_0px_7px_0px_rgba(0,0,0,0.1)] p-6 my-6">
            <h2 className="text-2xl font-semibold text-gray-800 mb-6 text-center">Register New Visitor</h2>
            <form onSubmit={handleRegister} className="space-y-6 w-full">
              ...
              <div className="text-center">
                <button type="submit" className="primary-btn w-1/3" disabled={loading}>
